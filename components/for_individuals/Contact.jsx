...
const Contact = () => {
  ...
  return (
    <div className="custom-container md:py-8 py-0">
      <div className="xl:w-[70%] w-[90%] lg:h-[630px] h-fit transition flex lg:flex-row flex-col gap-8 items-center mx-auto">
        ...
        <div className="lg:w-[50%] w-full h-full bg-white relative text-black sm:py-6 py-3 ms:px-10 px-0 transition">
          <div className="flex items-start justify-center flex-col w-full h-full">
            <p className="relative font-semibold mb-3 text-yellow text-start">
              {t("application.subTitle")}
            </p>
            <h1 className="text-[30px] mb-3 text-blue text-start font-barlowBlack">
              {t("application.title")}
            </h1>
            <p className="text-start mb-8">{t("application.desc")}</p>
